...
class NodeRevampController extends Controller
{
    ...
    public function getCTDiseaseAssoc_new(Request $request)
    {
        ...
        //         ->selectRaw('distinct destination_node as selected_nodes')
        //         ->where('deleted', '=', 1)
        ...
        for($i=0; $i < count($result2); $i++) {
            // echo "<br/>".$result2[$i]->selected_nodes;
            $destinationNodes_ids[$i] = $result2[$i]->selected_nodes;
        ...
        //         // return response()->json([
        //         //     'destinationNode' => $destinationNodesIdRelevantIds
        //         // ]);
        //     }
        // }else{ //////////// IF destination node not empty////////////////
        //     // return response()->json([
        //     //     'destinationNode' => $destinationNodeImplode
        //     // ]);
        // }
        ...
        $destinationNodeImplode = $destinationNode->implode(', ');
        if(!empty($destinationNodeImplode)){
            $sql = $sql . " or ctdr.node_id in (".$destinationNodeImplode.")";
        }
        else{
            $sql = $sql . " or ctdr.node_id in (".$destinationNodesIdRelevantIds.")";
            // $sql = $sql . " and destination_node in (10648938,10649888)";
        }
